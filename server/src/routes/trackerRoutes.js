...
const { pairGpsTracker, pairSelfGpsTracker, trackerLocationIngest } = require('../middleware/schemas');
...
router.post('/pair-self', validate(pairSelfGpsTracker), (req, res) => trackerController.pairSelf(req, res));
