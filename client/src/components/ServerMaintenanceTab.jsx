...
const ServerMaintenanceTab = ({ lang }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', padding: '1rem' }}>
      ...
      {/* Quick Deploy */}
      <CollapsibleSection sectionKey="quickDeploy" title={manual.quickDeploy.title}>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>
          {manual.quickDeploy.description}
        </p>
        <CommandBlock command={manual.quickDeploy.command} id="deploy" />
      </CollapsibleSection>

      {/* Credentials */}
      <CollapsibleSection sectionKey="credentials" title={manual.credentials.title}>
      ...
      {/* Backup */}
      <CollapsibleSection sectionKey="backup" title={manual.backup.title}>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>
          {manual.backup.description}
        </p>
        <CommandBlock command={manual.backup.command} id="backup" />
      </CollapsibleSection>

      {/* Migration */}
      <CollapsibleSection sectionKey="migration" title={manual.migration.title}>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>
          {manual.migration.description}
        </p>
        <CommandBlock command={manual.migration.command} id="migration" />
      </CollapsibleSection>

      {/* Diagnostics */}
      <CollapsibleSection sectionKey="diagnostics" title={manual.diagnostics.title}>
      ...
      {/* Directory Structure */}
      <CollapsibleSection sectionKey="directory" title={manual.directory.title}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
