              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem', marginTop: '0.5rem' }}>
                  {(!isSidebarCollapsed || isMobile) && (
                    <div style={{ padding: '0.5rem 1.15rem', fontSize: '0.75rem', fontWeight: '950', color: 'rgba(255,255,255,0.3)', letterSpacing: '0.05em' }}>
                      {capitalize(t('systemAdministration'))}
                    </div>
                  )}
                  ...
                  {(!isSidebarCollapsed || isMobile) && (
                    <div style={{ padding: '1rem 1.15rem 0.5rem', fontSize: '0.75rem', fontWeight: '950', color: 'rgba(255,255,255,0.3)', letterSpacing: '0.05em' }}>
                      {capitalize(t('operationsUnit'))}
                    </div>
                  )}
